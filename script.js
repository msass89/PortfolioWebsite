...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const projects = [
    new Project(
      ...
      "Self-Service-Portal", 
      "A multi-tenancy SaaS fullstack-project build with ASP.NET Razor Pages. Currently in development. Live-demo on Azure.", 
    ...
    new Project("web", 
      ...
      "A RESTful API for managing inventory items and orders using Asp.Net and Swagger. Live-demo on monsterasp.net.", 
